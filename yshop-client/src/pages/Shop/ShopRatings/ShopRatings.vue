<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      <div class="overview">
        <div class="overview-left"><h1 class="score">4.7</h1>
        ...
        <div class="overview-right">
          ...
          <div class="score-wrapper"><span class="title">商品评分</span>
            ...
            <span class="score">4.7</span></div>
          <div class="delivery-wrapper"><span class="title">送达时间</span> <span class="delivery">30 分钟</span></div>
        </div>
      </div>
      <div class="split"></div>
        ...
        <ul>
          <li class="rating-item">
            <div class="avatar"><img width="28" height="28"
                                     src="http://static.galileo.xiaojukeji.com/static/tms/default_header.png"></div>
            <div class="content"><h1 class="name">aa</h1>
              <div class="star-wrapper">
                <Star :score="5" :size="24"/>
                <span class="delivery">30</span></div>
              <p class="text">不错</p>
              <div class="recommend"><span class="iconfont icon-thumb_up"></span> <span class="item">南瓜粥</span> <span
                class="item">皮蛋瘦肉粥</span> <span class="item">扁豆焖面</span></div>
          ...
          <li class="rating-item">
            ...
            <div class="content"><h1 class="name">aa</h1>
              <div class="star-wrapper">
                ...
                <span class="delivery">30</span></div>
              <p class="text">不错</p>
              <div class="recommend"><span class="iconfont icon-thumb_down"></span></div>
              <div class="time">2016-07-23 21:52:44</div>
            </div>
          </li>
        </ul>
